            ...
            if ( k > 5 ) {
              ...
              if ( k > 6 ) {
                ...
                if ( k > 7 ) {
                  var i = 7
                  while ( i < k ) {
                    sum += p7(t(i-7),t(i-6),t(i-5),t(i-4),t(i-3),t(i-2),t(i-1))(t(i))
                    i += 1
                  }
                }
              }
...
object PriorMM7 {
  ...
  def apply(
    ...
    p6: Conditional6PMF,
    p7: Conditional7PMF
  ): PriorMM7 = new PriorMM7(p0,p1,p2,p3,p4,p5,p6,p7)

  def apply(bag: BagOfPMFs): PriorMM7 = {
    val p0 = bag._0("0")
    val p1 = bag._1("1")
    val p2 = bag._2("2")
    val p3 = bag._3("3")
