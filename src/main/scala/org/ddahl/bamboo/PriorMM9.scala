            ...
            if ( k > 5 ) {
              ...
              if ( k > 6 ) {
                ...
                if ( k > 7 ) {
                  ...
                  if ( k > 8 ) {
                    sum += p8(t(0),t(1),t(2),t(3),t(4),t(5),t(6),t(7))(t(8))
                    if ( k > 9 ) {
                      var i = 9
                      while ( i < k ) {
                        sum += p9(t(i-9),t(i-8),t(i-7),t(i-6),t(i-5),t(i-4),t(i-3),t(i-2),t(i-1))(t(i))
                        i += 1
                      }
                    }
                  }
...
object PriorMM9 {
  ...
  def apply(
    ...
    p8: Conditional8PMF,
    p9: Conditional9PMF
  ): PriorMM9 = new PriorMM9(p0,p1,p2,p3,p4,p5,p6,p7,p8,p9)

  def apply(bag: BagOfPMFs): PriorMM9 = {
    val p0 = bag._0("0")
    val p1 = bag._1("1")
    val p2 = bag._2("2")
    val p3 = bag._3("3")
    ...
    val p8 = bag._8("8")
    val p9 = bag._9("9")
    apply(p0,p1,p2,p3,p4,p5,p6,p7,p8,p9)
  }
